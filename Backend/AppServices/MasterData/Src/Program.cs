        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.appservices.masterdata.json");
                    config.AddJsonFile("config/appspecific/backend.appservices.masterdata.Development.json", true);
