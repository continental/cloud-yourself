...
namespace CloudYourself.Backend.AppServices.CloudAccounts
{
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.appservices.cloudaccounts.json");
                    config.AddJsonFile("config/appspecific/backend.appservices.cloudaccounts.Development.json", true);
