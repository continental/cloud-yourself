        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.gateways.automationapi.json");
                    config.AddJsonFile("config/appspecific/backend.gateways.automationapi.Development.json", true);
