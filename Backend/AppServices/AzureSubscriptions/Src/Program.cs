        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.appservices.azuresubscriptions.json");
                    config.AddJsonFile("config/appspecific/backend.appservices.azuresubscriptions.Development.json", true);
