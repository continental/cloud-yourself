...
namespace CloudYourself.Backend.AppServices.MasterData.Controllers
{
    ...
    public class TenantsController : HypermediaController
    {
        ...
        public TenantsController(ILogger<TenantsController> logger, MasterDataDbContext dbContext)
        {
            _logger = logger;
        ...
        [HttpGet]
        [Route("api/master-data/tenants/{id}")]
        ...
        [HttpGet]
        [Route("api/master-data/tenants/template")]
