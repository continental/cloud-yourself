        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.gateways.selfserviceportalapi.json");
                    config.AddJsonFile("config/appspecific/backend.gateways.selfserviceportalapi.Development.json", true);
