...
namespace CloudYourself.Backend.AppServices.Azure.Migrations
{
    ...
    [Migration("20210721113310_AddManagedResourcesSettings")]
    partial class AddManagedResourcesSettings
    {
            ...
            modelBuilder.Entity("CloudYourself.Backend.AppServices.Azure.Aggregates.Tennant.TenantSettings", b =>
                {
                    ...
                    b.OwnsOne("CloudYourself.Backend.AppServices.Azure.Aggregates.Tennant.ManagedResources", "ManagedResources", b1 =>
                        {
                            b1.Property<int>("TenantSettingsId")
                                .HasColumnType("int");

                            b1.Property<string>("TemplateSpecsResourceGroup")
                                .HasColumnType("nvarchar(max)");
