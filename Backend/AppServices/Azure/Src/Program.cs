        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.appservices.azure.json");
                    config.AddJsonFile("config/appspecific/backend.appservices.azure.Development.json", true);
