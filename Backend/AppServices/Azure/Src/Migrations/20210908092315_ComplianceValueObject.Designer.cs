...
namespace CloudYourself.Backend.AppServices.Azure.Migrations
{
    ...
    [Migration("20210908092315_ComplianceValueObject")]
    partial class ComplianceValueObject
    {
            ...
            modelBuilder.Entity("CloudYourself.Backend.AppServices.Azure.Aggregates.Subscription.Subscription", b =>
                {
                    ...
                    b.OwnsOne("CloudYourself.Backend.AppServices.Azure.Aggregates.Subscription.Compliance", "Compliance", b1 =>
                        {
                            ...
                            b1.Property<string>("PolicyEvaluationResultUrl")
                                .HasColumnType("nvarchar(max)");
