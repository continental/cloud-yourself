        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    config.AddJsonFile("config/appspecific/backend.appservices.billing.json");
                    config.AddJsonFile("config/appspecific/backend.appservices.billing.Development.json", true);
